...
sendOrder(m.chat, teks, "391028153034238", fs.readFileSync('./media/image/mans.jpg'), 2022, "Chu bot ~ Multi Device", "6283155687629@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
const relink = ['https://chat.whatsapp.com/BpuUbEx8niML0pmEqkbp8L','https://chat.whatsapp.com/LdVST4O2wcX2xvpWZNZH3F']
...
cekbotinfo = `Anda menggunakan Tamade Chiyu versi terbaru (${ceknyai}), belum ada update dari owner`
} else {
cekbotinfo = `Anda menggunakan Tamade Chiyu v${ceknyai}, owner telah mengupdate Tamade Chiyu ke v${zckmn.update}, ketik cekupdate untuk melihat versi terbaru`
}
...
let prefs = ` ▸ ${prefix}`
const listmn = `*Tamade Chiyu - MD*
Aku Adalah Tamade Chiyu bot di panggil Chu2
...
GROUP MENU
☃${prefs}linkgroup  _undefined_
☃${prefs}setppgc  _image_
☃${prefs}setname _query_
☃${prefs}setdesc _query_
☃${prefs}ephemeral _query_
☃${prefs}hidetag _query_
☃${prefs}tagall _query_
☃${prefs}promote _query_
☃${prefs}demote _query_
☃${prefs}vote _query_
☃${prefs}devote _undefined_
☃${prefs}upvote _undefined_
☃${prefs}cekvote _undefined_
☃${prefs}hapusvote _undefined_
☃${prefs}antidelete _on/off_
☃${prefs}antilink _on/off_
☃${prefs}antihidetag _on/off_
☃${prefs}autokick _on/off_
☃${prefs}welcome _on/off_
☃${prefs}autorevoke _on/off_
☃${prefs}setwelcome _query_
☃${prefs}add _query_
☃${prefs}kick _query_
☃${prefs}revoke _undefined_
☃${prefs}group <open/close>
☃${prefs}editinfo <open/close>

DOWNLOADER
☃${prefs}instagram _query_
☃${prefs}tiktok _query_
☃${prefs}twitter _query_
☃${prefs}facebook _query_
☃${prefs}youtube _query_
☃${prefs}igstory _query_
☃${prefs}mediafire _query_
☃${prefs}gitclone _query_
☃${prefs}jpeg _query_
☃${prefs}mp4 _query_

SEARCH MENU
☃${prefs}gimage _query_
☃${prefs}ytsearch _query_
☃${prefs}searchgc _query_
☃${prefs}play _query_
☃${prefs}happymod _query_
☃${prefs}servermc _undefined_
☃${prefs}mcpedl _query_
☃${prefs}google _query_
☃${prefs}pinterest _query_

CONVERT MENU
☃️${prefs}sticker <image/video>
☃️${prefs}smeme <image>
☃️${prefs}stickerwm <reply>
☃️${prefs}styletext _query_
☃️${prefs}removebg _query_
☃️${prefs}ttp _query_
☃️${prefs}attp _query_
☃️${prefs}emojimix _query_
☃️${prefs}emojimix2 _query_
☃️${prefs}tomp3 _video_
☃️${prefs}tovn _video_
☃️${prefs}toaudio _video_
☃️${prefs}togif _video_
☃️${prefs}tourl _query_
☃️${prefs}tomp4 _sticker_
☃️${prefs}toimage _sticker_

TOOLS MENU
☃️${prefs}profile _query_
☃️${prefs}inspect _query_
☃️${prefs}getcase _query_
☃️${prefs}getname _query_
☃️${prefs}getpic _query_
☃️${prefs}nulis _query_
☃️${prefs}kalkulator _query_
☃️${prefs}get _query_
☃️${prefs}quoted _query_
☃️${prefs}join _query_
☃️${prefs}fliptext _query_
☃️${prefs}tohuruf _query_
☃️${prefs}volume <quer>
☃️${prefs}bass _query_
☃️${prefs}tempo _query_
☃️${prefs}translate _query_

PRIMBON MENU
☃️${prefs}nomorhoki _query_
☃️${prefs}artimimpi _query_
☃️${prefs}artinama _query_
☃️${prefs}ramaljodoh _query_
☃️${prefs}ramaljodohbali _query_
☃️${prefs}suamiistri _query_
☃️${prefs}ramalcinta _query_
☃️${prefs}cocoknama _query_
☃️${prefs}pasangan _query_
☃️${prefs}jadiannikah _query_
☃️${prefs}sifatusaha _query_
☃️${prefs}rezeki _query_
☃️${prefs}pekerjaan _query_
☃️${prefs}nasib _query_
☃️${prefs}penyakit _query_
☃️${prefs}tarot _query_
☃️${prefs}fengshui _query_
☃️${prefs}haribaik _query_
☃️${prefs}harisangar _query_
☃️${prefs}harisial _query_
☃️${prefs}nagahari _query_
☃️${prefs}arahrezeki _query_
☃️${prefs}peruntungan _query_
☃️${prefs}weton _query_
☃️${prefs}karakter _query_
☃️${prefs}keberuntungan _query_
☃️${prefs}memancing _query_
☃️${prefs}masasubur _query_
☃️${prefs}zodiak _query_
☃️${prefs}shio _query_

HAPPY MENU
☃️${prefs}halah _query_
☃️${prefs}hilih _query_
☃️${prefs}huluh _query_
☃️${prefs}heleh _query_
☃️${prefs}holoh _query_
☃️${prefs}math _query_
☃️${prefs}tictactoe _query_
☃️${prefs}delttt _query_
☃️${prefs}tebak _query_
☃️${prefs}family100 _undefined_
☃️${prefs}suitpvp _query_

MAKER MENU
☃️${prefs}textmaker _option_
☃️${prefs}matrix2
☃️${prefs}sky
☃️${prefs}joker
☃️${prefs}magma
...
DATABASE
☃️${prefs}setcmd _query_
☃️${prefs}listcmd _undefined_
☃️${prefs}delcmd _query_
☃️${prefs}lockcmd _query_
☃️${prefs}addmsg _query_
☃️${prefs}listmsg _undefined_
☃️${prefs}getmsg _query_
☃️${prefs}delmsg _query_

OTHER
☃️${prefs}owner _undefined_
☃️${prefs}listpc _undefined_
☃️${prefs}listgc _undefined_
☃️${prefs}mcserver _query_
☃️${prefs}sc _undefined_
☃️${prefs}ping _undefined_
☃️${prefs}thanksto _query_
☃️${prefs}afk _query_
☃️${prefs}spam _query_
☃️${prefs}cekupdate [UpdateBot]
☃️${prefs}getscmd [GetSticker]
☃️${prefs}listblock [ListBanned]
☃️${prefs}delete _query_
☃️${prefs}infochat _query_
☃️${prefs}request _query_
☃️${prefs}report _query_
☃️${prefs}donate _undefined_
☃️${prefs}listonline _undefined_
...
☃️${prefs}self 
☃️${prefs}public 
☃️${prefs}bcall _query_
☃️${prefs}bcgroup _query_
☃️${prefs}chat _query_
☃️${prefs}anticall _query_
☃️${prefs}antitag _query_
☃️${prefs}autoread _query_
☃️${prefs}ban _add/del_
☃️${prefs}block add/del
☃️${prefs}cowner add/del
> / => / $ / <

THANKS TO :
adiwajshing, MhankBarBar, Nurutomo, Uzui, ${thnsto}, Heroku, Replit, Railway, Termux, Rest APIs, Penyedia Module, Mastah Lainya
...
if (isBanChat) return reply(mess.banChat)
     ...
     reply(`Tunggu sebentar sambil membuat logo sekitar 1 menit`) 
     console.log(anui)
    mans.sendMessage(from, {image:{url:anui}, caption:"Ini dia!"}, {quoted:m})
}
   break
  case 'whitebear':{
  	if (isBan) return reply(mess.ban)	 			
...
case 'pornhub':{
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if(!q) return reply(`Contoh: ${prefix + command} Chu | Bot`)
reply(mess.wait)
  inilogo4 = args.join(" ")
inilogo9 = args.join(" ")
...
console.log(anu)
mans.sendMessage(from,{image:{url:anu}, caption:"Ini dia!"},{quoted:m})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
...
"externalAdReply": {
"title": `Chu bot`,
"body": `Subscribe To Channel YouTube Chu bot`,
"previewType": "PHOTO",
"thumbnailUrl": thum,
"thumbnail": thum,
"sourceUrl": "https://github.com/IkawaTeam"
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./media/image/mans.jpg'), 2022, "Chu bot ~ Multi Device", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"NOMOR BOT WHATSAPP, MULTI DEVICE TERBARU FITUR BERJIBUN - Uzui",
body:"© Chu bot by Ikawa Team",
thumbnail: log0,
mediaType:2,
mediaUrl: "https://github.com/IkawaTeam",
sourceUrl: "https://github.com/IkawaTeam"
}}
}
mans.sendMessage(m.chat, buttonMessage, { quoted: m })
...
case 'google': {
if (isBan) return m.reply(mess.ban)
if (!args[0]) return m.reply(`Example: ${prefix + command} _query_\nUses : ${prefix + command} apa arti cinta`)
...
caption: teks,
footer: "© Chu bot - MyMainas",
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title:"Chu bot - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Chu bot - Facebook Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Chu bot - Tiktok Downloader",
...
case 'waifu': case 'loli':
	...
	if (isBanChat) return reply(mess.banChat)
					...
					.then(({data}) => {
					mans.sendImage(m.chat, data.url, mess.success, m)
					})
					break
case 'couple':  case 'ppcouple': case 'ppcp': {
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                mans.sendMessage(m.chat, { image: { url: random.male }, caption: `Ini Couple Male` }, { quoted: m })
                mans.sendMessage(m.chat, { image: { url: random.female }, caption: `Ini Couple Female` }, { quoted: m })
            }
	    break
	case 'neko':
   if (isBan) return reply(mess.ban)
...
reply(mess.wait)						
   waifud = await axios.get('https://waifu.pics/api/sfw/neko')
      ...
      headerType: 4
            ...
            await mans.sendMessage(m.chat,buttonssMessage, { quoted:m }).catch(err => {
                    return('Error!')
                })               
                break
   case 'shinobu':  
...
await mans.sendMessage(m.chat,buttonsesMessage, { quoted:m }).catch(err => {
     return('Error!')
    })               
break
case 'megumin':
...
await mans.sendMessage(m.chat,buttonzMessage, { quoted:m }).catch(err => {
     return('Error!')
    })               
break     
case 'animeneko':
...
reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/neko`)
      ...
      headerType: 4
            ...
            await mans.sendMessage(m.chat, buttonsTsMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehug':
...
reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/hug`)
      ...
      headerType: 4
            ...
            await mans.sendMessage(m.chat, buttonussMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animekiss':
...
reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/kiss`)
      ...
      headerType: 4
            ...
            await mans.sendMessage(m.chat, bxxuttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
